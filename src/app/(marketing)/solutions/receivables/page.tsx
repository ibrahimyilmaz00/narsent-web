...
import { Check, Activity, BarChart3, BellRing, AlertTriangle, CheckCircle, Timer, Brain, ArrowLeftRight } from "lucide-react";
                ...
                <div className="container mx-auto max-w-4xl text-center">
                    <Reveal direction="up">
                        ...
                        <h1 className="mb-6 text-3xl font-extrabold tracking-tight text-white sm:text-4xl md:text-5xl lg:text-6xl">
                            Don&apos;t Chase Receivables — Manage Them Autonomously.
                        </h1>
                        <p className="mx-auto mb-10 max-w-2xl text-lg leading-relaxed text-zinc-400">
                            Stop chasing overdue invoices. Narsent Horizon AI analyzes
                            customer payment behaviors, predicts risky collections in advance,
                            and protects your cash cycle with autonomous alerts.
                        </p>
                ...
                <div className="container mx-auto max-w-6xl">
                    <Reveal direction="up">
                        <h2 className="mb-16 text-center text-3xl font-bold text-white md:mb-20 md:text-4xl">
                            From Reactive Collections to Autonomous Revenue Assurance.
                        </h2>
                    </Reveal>
                        ...
                        {[
                            {
                                ...
                                text: "Minimize collection times with autonomous workflows instead of manual tracking.",
                            },
                            {
                                icon: Brain,
                                title: "Intelligent Risk Scoring",
                                text: "Dynamic risk analysis based on real-time payment behaviors, not just historical data.",
                            },
                            {
                                icon: ArrowLeftRight,
                                title: "Autonomous Reconciliation",
                                text: "An AI layer that flawlessly matches bank receipts with ERP invoices.",
                            },
                        ].map((pillar, index) => {
                    ...
                    <Reveal direction="left">
                        <div className="flex flex-col">
                            ...
                            <p className="mb-8 max-w-lg text-base leading-relaxed text-zinc-400">
                                Catch even the smallest deviations in your customers&apos; payment
                                behaviors. Autonomously analyzes systemic errors or intentional
                                delays, stopping cash leakage before it forms.
                            </p>
                        ...
                        <div className="relative flex items-center justify-center">
                            ...
                            <div className="relative flex h-80 w-full flex-col overflow-hidden rounded-2xl border border-zinc-800 bg-[#11121A] p-6 backdrop-blur-xl">
                                ...
                                <div className="relative z-10 flex flex-1 flex-col gap-3">
                                    {[
                                        { customer: "Customer #2841", change: "Payment period +12 day deviation", severity: "high" },
                                        { customer: "Customer #1205", change: "Partial payment pattern started", severity: "medium" },
                                        { customer: "Customer #3092", change: "Return rate increased 340%", severity: "high" },
                                    ].map((item) => (
                                        <div
                                            key={item.customer}
                                    ...
                                    <div className="mt-auto flex items-center gap-2 rounded-xl border border-zinc-800/60 bg-white/[0.02] px-4 py-2.5">
                                        ...
                                        <span className="text-[10px] text-zinc-500">3 anomalies actively monitored</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div className="container mx-auto grid max-w-6xl grid-cols-1 items-center gap-12 lg:grid-cols-2 lg:gap-20">
                                ...
                                <div className="relative z-10 flex flex-1 flex-col gap-4">
                                    <div className="rounded-xl border border-zinc-800/60 bg-white/[0.02] px-5 py-4">
                                        <div className="mb-2 flex items-center justify-between">
                                            <span className="text-xs text-zinc-500">Traditional Credit Score</span>
                                            <span className="text-sm font-bold text-zinc-400">720</span>
                                        </div>
                                        <div className="h-1.5 w-full overflow-hidden rounded-full bg-zinc-800">
                                            <div className="h-full w-[72%] rounded-full bg-zinc-600" />
                                        </div>
                                        <span className="mt-1 block text-[10px] text-zinc-600">Static · Monthly update</span>
                                    </div>
                                    <div className="rounded-xl border border-cyan-500/20 bg-cyan-500/5 px-5 py-4">
                                        ...
                                        <span className="mt-1 block text-[10px] text-cyan-400/60">Dynamic · Real-time ERP data</span>
                                    </div>
                                    <div className="mt-auto flex items-center justify-center gap-2 rounded-xl border border-emerald-500/20 bg-emerald-500/5 px-4 py-2.5">
                                        ...
                                        <span className="text-xs font-semibold text-emerald-300">
                                            +127 points more precise risk detection
                                        </span>
                                    </div>
                                </div>
                            </div>
                    ...
                    <Reveal direction="right">
                        <div className="flex flex-col">
                            ...
                            <p className="mb-8 max-w-lg text-base leading-relaxed text-zinc-400">
                                Forget traditional, cumbersome credit scores. Narsent blends
                                real-time transaction data from your ERP with banking data to
                                produce a living trust score for every customer.
                            </p>
                            <ul className="flex flex-col gap-4">
                                {[
                                    "Dynamic limit management",
                                    "Real-time risk updates",
                                    "Autonomous credit approval drafts",
                                ].map((item) => (
                                    <li key={item} className="flex items-center gap-3">
                ...
                <div className="container mx-auto grid max-w-6xl grid-cols-1 items-center gap-12 lg:grid-cols-2 lg:gap-20">
                    <Reveal direction="left">
                        <div className="flex flex-col">
                            ...
                            <p className="mb-8 max-w-lg text-base leading-relaxed text-zinc-400">
                                Get alerted months before maturity, not after. Horizon AI
                                detects bankruptcy or default risks from micro-changes in
                                payment performance.
                            </p>
                            <ul className="flex flex-col gap-4">
                                {[
                                ...
                                <div className="relative z-10 flex flex-1 flex-col gap-3">
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div className="rounded-lg border border-emerald-500/20 bg-emerald-500/5 px-3 py-2">
                                            <span className="text-[10px] text-zinc-500">90 days ago</span>
                                            <p className="text-xs font-medium text-emerald-300">Micro-deviation detected</p>
                                        </div>
                                    </div>
                                    <div className="flex items-start gap-3">
                                        <div className="mt-1 flex flex-col items-center">
                                        ...
                                        <div className="rounded-lg border border-amber-500/20 bg-amber-500/5 px-3 py-2">
                                            <span className="text-[10px] text-zinc-500">45 days ago</span>
                                            <p className="text-xs font-medium text-amber-300">Autonomous reminder sent</p>
                                        </div>
                                    </div>
                                    <div className="flex items-start gap-3">
                                        <div className="mt-1 flex flex-col items-center">
                                        ...
                                        <div className="rounded-lg border border-red-500/20 bg-red-500/5 px-3 py-2">
                                            <span className="text-[10px] text-zinc-500">15 days ago</span>
                                            <p className="text-xs font-medium text-red-300">Default risk → Legal flow triggered</p>
                                        </div>
                                    </div>
                                    <div className="mt-auto flex items-center gap-3">
                                        ...
                                        <div className="rounded-lg border border-[#E5F33D]/20 bg-[#E5F33D]/5 px-3 py-2">
                                            ...
                                            <p className="text-xs font-bold text-[#E5F33D]">Payment received ✓ Closed on time</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div className="container mx-auto grid max-w-6xl grid-cols-1 items-center gap-12 lg:grid-cols-2 lg:gap-20">
                    <Reveal direction="left">
                        <div className="relative flex items-center justify-center">
                            ...
                            <div className="relative flex h-80 w-full flex-col overflow-hidden rounded-2xl border border-zinc-800 bg-[#11121A] p-6 backdrop-blur-xl">
                                ...
                                <div className="relative z-10 flex flex-1 flex-col gap-3">
                                    {[
                                        { bank: "Garanti — ₺84,250.00", invoice: "INV-2024-1847", status: "matched" },
                                        { bank: "Akbank — ₺215,000.00", invoice: "INV-2024-1923", status: "matched" },
                                        { bank: "Isbank — ₺12,740.50", invoice: "INV-2024-1901", status: "matched" },
                                    ].map((item) => (
                                        <div
                                            key={item.invoice}
                                    ...
                                    <div className="mt-auto rounded-xl border border-red-500/15 bg-red-500/5 px-4 py-3">
                                        <div className="flex items-center justify-between">
                                            ...
                                            <div className="flex items-center gap-1.5">
                                                ...
                                                <span className="text-[10px] font-bold text-amber-400">REFUND FLOW</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <Reveal direction="right">
                        <div className="flex flex-col">
                            ...
                            <p className="mb-8 max-w-lg text-base leading-relaxed text-zinc-400">
                                Match thousands of incoming payments to the correct invoices
                                with 100% accuracy in seconds — despite messy payment
                                descriptions.
                            </p>
                            <ul className="flex flex-col gap-4">
                                {[
                                    "100% manual workload elimination",
                                    "Full bank-ERP synchronization",
                                    "Autonomous erroneous payment refund flow",
                                ].map((item) => (
                                    <li key={item} className="flex items-center gap-3">
            ...
            >
                <div className="container mx-auto max-w-5xl">
                    <Reveal direction="up">
                        <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
                            {[
                                { value: "30%", label: "Average DSO (Collection Time) Reduction" },
                                { value: "100%", label: "Manual Invoice-Receipt Matching Elimination" },
                                { value: "5x", label: "Early Warning (Default Alert) Precision" },
                            ].map((metric) => (
                                <div
                                    key={metric.value}
                ...
                <div className="container mx-auto max-w-3xl text-center">
                    <Reveal scale>
                        <h2 className="mb-6 text-3xl font-bold text-white md:text-4xl">
                            Make Your Collection Processes Autonomous.
                        </h2>
                        <p className="mx-auto mb-10 max-w-xl text-base text-zinc-400">
                            Experience the proactive collection infrastructure with a
                            30-minute live demo.
                        </p>
                        <Link
                            href="/request-demo"
