...
const sidebarItems = [
    { label: "Dashboard", href: "/narsent-hq-vault-99", icon: LayoutDashboard },
    { label: "Blog & Resources", href: "/narsent-hq-vault-99/blog", icon: FileText },
    { label: "Demo Leads", href: "/narsent-hq-vault-99/leads", icon: Users },
    { label: "Site Settings", href: "/narsent-hq-vault-99/settings", icon: Settings },
];
...
export default function AdminLayout({
    ...
    const isLoginPage = pathname === "/narsent-hq-vault-99/login";
            ...
            <aside className="fixed inset-y-0 left-0 z-30 flex w-64 flex-col border-r border-zinc-800/60 bg-[#080a10]">
                ...
                <nav className="flex flex-1 flex-col gap-1 px-3 py-5">
                    {sidebarItems.map((item) => {
                        const isActive =
                            item.href === "/narsent-hq-vault-99"
                                ? pathname === "/narsent-hq-vault-99"
