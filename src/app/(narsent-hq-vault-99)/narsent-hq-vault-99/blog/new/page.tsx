...
function BlogForm() {
    ...
    const handlePublish = useCallback(
        ...
        [title, content, category, author, slug, router]
    );
        ...
        <form onSubmit={handlePublish} className="flex flex-col gap-6">
            ...
            <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-3">
                    ...
                    >
                        ...
                        {publishing ? (editId ? "Updating..." : "Publishing...") : (editId ? "Update" : "Publish")}
                    </button>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 gap-8 lg:grid-cols-12">
                ...
                <div className="lg:col-span-8">
                    {/* Cover image upload */}
                    <div className="flex flex-col gap-2 rounded-xl border border-zinc-800 bg-[#11121A] p-6 text-zinc-400">
                        <label className="text-sm font-semibold text-zinc-300 flex items-center gap-2">
                            <ImagePlus className="h-4 w-4" /> Cover Image URL
                        </label>
                        <div className="flex items-center gap-3">
                            <div className="relative flex-1">
                                ...
                                <input
                                    ...
                                    className="w-full rounded-lg border border-zinc-700 bg-black/40 py-2.5 pl-10 pr-4 text-sm text-white placeholder:text-zinc-600 outline-none transition-colors focus:border-[#E5F33D]/40 focus:ring-1 focus:ring-[#E5F33D]/20"
                                />
                            </div>
                        </div>
                    </div>
